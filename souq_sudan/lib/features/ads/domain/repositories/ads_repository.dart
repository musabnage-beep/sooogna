...
abstract class AdsRepository {
  ...
  Future<Result<List<Ad>>> getAdsByCategory(String category, {Object? lastDoc, int limit = 20});
  Future<Result<List<Ad>>> searchAds(String query, {String? category, String? location, double? minPrice, double? maxPrice, String? sortBy});
